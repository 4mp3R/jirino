    ...
    with_mocks [
      ...
      search_options = [
        params: [
          ...
          {"startAt", 0},
          {"jql",
           "project = \"Super Duper Project\" AND issuetype = Bug AND resolution = Unresolved AND (Sprint = EMPTY OR Sprint not in (openSprints(), futureSprints())) ORDER BY created DESC"},
          {"fields", "summary,priority,status,creator,issuetype,assignee,created,description"}
        ]
      ]
    ...
    with_mocks [
      ...
      search_options = [
        params: [
          ...
          {"startAt", 0},
          {"jql",
           "project = \"Super Duper Project\" AND Sprint in openSprints() ORDER BY created DESC"},
          {"fields", "summary,priority,status,creator,issuetype,assignee,created,description"}
        ]
      ]
      ...
      },
      {
        ...
        [
          get!: fn _url, _header, options ->
            {_, startIndex} = Enum.find(options[:params], fn {key, _} -> key == "startAt" end)
